...
import com.zzdc.uwb.View.Widget.OnSingleClickListener;
...
public class FMMapOperation extends Activity implements OnFMMapInitListener {
    ...
    private static final FMMapCoord CENTER_COORD = new FMMapCoord(1.296164E7, 4861800.0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fmap_operate);
    ...
    private void openMapByPath() {
        ...
        mAnimationFactory = mMap.getAnimationFactory();
    }
    ...
    public void onMapInitSuccess(String path) {
        ...
        labels[0] = getString(R.string.operate_btn_move, mMap.getFocusGroupId(), CENTER_COORD.x, CENTER_COORD.y);
    ...
    private void animateMove() {
        mMap.moveToCenter(CENTER_COORD, true);
    }
    ...
    private void animateTilt() {
        ...
        float fromAngle = mMap.getTiltAngle();
        ...
        animRotate.setOnFMAnimationListener(new FMAnimation.OnFMAnimationListener() {
            ...
            public void updateAnimationFrame(String s, Object last, Object current) {
                ...
                mMap.setTiltAngle(angel.floatValue());
            }
    ...
    private void animateRotate() {
        ...
        animRotate.setOnFMAnimationListener(new FMAnimation.OnFMAnimationListener() {
            ...
            public void updateAnimationFrame(String s, Object last, Object current) {
                //执行旋转
                Double angel = (Double) current;
                mMap.setRotateAngle(angel.floatValue());
            }
    ...
    private float getCurrentAngle(float toAngle) {
        float startAngle = mMap.getRotateAngle();
